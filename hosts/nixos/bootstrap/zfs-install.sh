...
# Example:
# nixy-zfs-install '/dev/disk/by-id/ata-P4-120_9D20106004931' '/dev/disk/by-id/ata-P4-120_9D20106004951' 'suzumiya' '2GiB' '512MiB'
...
export SWAP=$4
export BOOT=$5
export FLAKE="github:WeebSorceress/.dotfiles/kexec-tarball"
